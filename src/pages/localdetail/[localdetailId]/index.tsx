...
const LocalDetail = () => {
  ...
  return (
    <LocalDetailLayout>
      {localData && (
        <div className="mt-[30px] w-[360px] h-auto bg-primary bg-opacity-10 rounded-lg p-[20px]">
          ...
          <Link href={"/search"}>
            <button
              type="button"
              className="w-[320px] h-[50px] bg-primary flex flex-col items-center justify-center mt-[15px] hover:bg-point"
            >
              <p>인기 장소 찾아보기</p>
            </button>
          </Link>
