...
const SignInput: React.FC<SignInputProps> = ({ text, placeholder, type }) => {
  return (
    <div className="pt-[1.5rem] min-w-[18.75rem] sm:min-w-[31.25rem] lg:min-w-[43.75rem] 2xl:min-w-[56.25rem] flex flex-col gap-3 border-b-2 border-primary mx-auto pb-[0.313rem]">
